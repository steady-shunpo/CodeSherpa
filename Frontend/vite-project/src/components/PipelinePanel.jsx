    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="px-4 pt-4 pb-3 border-b border-border shrink-0">
        <div className="flex items-center justify-between mb-2">
          <p className="text-xs font-semibold uppercase tracking-wider text-muted-foreground/60">Pipeline</p>
          <span className="text-xs text-muted-foreground">{doneCount}/{agents.length} done</span>
        </div>
        {/* Progress */}
