  ...
  function send() {
    ...
    setTimeout(() => {
      dispatch({ type: 'ADD_MESSAGE', msg: {
        ...
        text: 'Got it — let me think through that in the context of what we know about this issue...',
        ts: Date.now(),
      }});
    }, 800);
  }
      ...
      {showPipelineBtn && (
        <div className="max-w-2xl mx-auto w-full px-4 pb-2 animate-in fade-in duration-300">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl border border-primary/40 bg-primary/8 text-primary text-sm font-medium hover:bg-primary/15 transition-colors"
          >
            <Zap size={14} />
